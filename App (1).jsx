...
// Standard playing card × 1.5 — portrait and landscape
const CARD = {
  portrait:  { w: 95.25, h: 133.35, px_w: 360, px_h: 504 },
  landscape: { w: 133.35, h: 95.25, px_w: 504, px_h: 360 },
}
...
function useFitText({ text, minSize = 8, maxSize = 22 }) {
...
function exportPDF(flashcards) {
  ...
  const cardCSS = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .page {
      display: grid;
      grid-template-columns: repeat(2, 95.25mm);
      grid-template-rows: repeat(2, 133.35mm);
      gap: 6mm;
    ...
    .card.portrait  { width: 95.25mm;  height: 133.35mm; }
    .card.landscape { width: 133.35mm; height: 95.25mm;  }
    ...
    .card-info {
      font-size: clamp(8pt, 2.2cqi, 12pt);
      line-height: 1.7;
      text-align: center;
      color: #4a4540;
      word-break: break-word;
...
function FitTextCard({ text, width, height, className, placeholder }) {
  const { containerRef, fontSize } = useFitText({ text, minSize: 8, maxSize: 22 })
